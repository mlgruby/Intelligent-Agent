...
public class VacuumAgentCleaner extends VacuumAgent {
private static final long serialVersionUID = -565563161972920536L;
	...
	public VacuumAgentCleaner(AgentBrain brain, int x, int y, String direction, String type) {
		super(brain);
		cleanerType = type;
		curLocationX = x;
		curLocationY = y;
...
//								System.out.println("X: " + j + " Y: " + i);
			...
			if (isGoalReached) {
				// if any of the dirt is present then reset the colour and clean the dirt
